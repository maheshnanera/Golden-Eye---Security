...
Line 55:12 Transforming let to the configured target environment ("es5") is not supported yet
Line 65:12 Transforming let to the configured target environment ("es5") is not supported yet
Line 71:12 Transforming let to the configured target environment ("es5") is not supported yet
Line 83:18 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 84:8 Transforming let to the configured target environment ("es5") is not supported yet
Line 116:14 Transforming let to the configured target environment ("es5") is not supported yet
Line 128:14 Transforming let to the configured target environment ("es5") is not supported yet
