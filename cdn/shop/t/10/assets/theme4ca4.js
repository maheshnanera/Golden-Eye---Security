...
Line 585:6 Transforming const to the configured target environment ("es5") is not supported yet
...
(function($) {
  ...
  jQuery(document).ready(function(){
    ...
    if ($('.setting-wrap').length) {
      ...
      $.fn.sectionJs = function(){
        ...
        }else if($this.data('section') == "Bestx_Collections") {
          $this.find('.bestcol-slider-active').Bestx_Collections();
    ...
    $.fn.Latest_Blog = function() {
      ...
      $.fn.Bestx_Collections = function() {
          var $Best_CollectionsVAR = this;
          $Best_CollectionsVAR.slick({
          infinite: true
        });
      };
    ...
    ------------------------------------*/
      ...
      var $ht_product_slider = $('.theme-product-image-slider');
      ...
      $('.color-categories li .variant_img').on('click', function(){
        ...
        jQuery(this).parents('.pgrid_9').find('.theme-product-image .pgrid_9_img a img').attr({ src: variantImage });
        return false;
      });
  ...
  proStikcyAddToCart();
    ...
    $('.theme-product').on('mouseenter', function () {
      $(this).addClass('active').parent().siblings().find('.theme-product').removeClass('active');
    });
    */
